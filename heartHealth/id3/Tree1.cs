...
namespace test_adm
{
    public class Tree
    {
        ...
        public static string Print(TreeNode node, string result)
        {
            ...
            //string result1 = seperatedResult[seperatedResult.Length - 1];
            return result;
        }


        //build the route and calculate the result
        ...
        private static TreeNode GetRootNode(DataTable data, string edge)
        {
            ...
            // Get all names, amount of attributes  for every column   
            ...
            for (var i = 0; i < data.Columns.Count - 1; i++)
            {
                ...
                //attributes is alist of MyAttribute , contains value of column and its different attributes
            }
        ...
        //return known values for each column
